...
function NoteTextInput({ onChange }: NoteTextInputProps) {
  ...
  return (
    <Textarea
      ...
      className="scrollbar-hidden placeholder:text-muted-foreground mu-2 mb-1 min-h-[250px] max-h-[250px] w-full resize-none border p-3 focus-visible:ring-0 focus-visible:ring-offset-0"
    />
  );
}
